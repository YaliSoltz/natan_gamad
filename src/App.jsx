...
function App() {
  const { cardHeader, cardTitle, cardSubTitle, cardContent, blessingFrom } =
    ...
    <>
      <div className="modal" style={{ display: !isOpen && "none" }}>
        <div className="modal-container">
          <h2>לחצי על המתנה שאת רוצה</h2>
          <br />
          <div className="gift-choices">
            {choices.map(({ text, url }, index) => (
              <div className="gift-choices__card" key={index}>
                <p style={{ fontSize: "1.2em", color: "white" }}>{text}</p>
                <br />
                <img
                  src={url}
                  alt={text}
                  style={{ width: 150, height: 150 }}
                  onClick={selectedPopup}
                />
              </div>
            ))}
          </div>
