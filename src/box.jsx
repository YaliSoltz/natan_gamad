...
const Box = () => {
  ...
  function stepClass(step) {
    merrywrapRef.current.className = "merrywrap";
    merrywrapRef.current.className = "merrywrap step-" + step;
  }
  function openBox() {
    stepClass(step);
  ...
  return (
    <div className="body">
      ...
      <div className="merrywrap" ref={merrywrapRef}>
        <div className="giftbox" onClick={openBox}>
          <div className="cover">
            <div />
          </div>
